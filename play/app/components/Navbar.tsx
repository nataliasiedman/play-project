    ...
    <header className="sticky top-0 z-50 w-full">
      ...
      >
        ...
        <div className="fixed left-0 right-0 top-[64px] z-50 mx-auto w-full max-w-6xl px-4">
          <div
            className={cn(
              "rounded-3xl border border-neutral-200 bg-white/90 p-3 shadow-xl backdrop-blur-xl",
              "transition",
          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <Link
                href={cta.href}
                className={cn(
                  "mt-1 rounded-2xl px-4 py-3 text-center text-sm font-extrabold text-white",
                  "bg-gradient-to-r from-pink-600/90 via-purple-600/90 to-blue-600/90",
                  "transition hover:brightness-110 active:scale-[0.99]",
                  "outline-none focus-visible:ring-2 focus-visible:ring-neutral-900/20"
                )}
              ...
              <p className="px-2 pt-1 text-center text-[11px] text-neutral-500">
